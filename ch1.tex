...
\begin{document}
    ...
    \chapter{Introduction}
        ...
        \begin{itemize}
            ...
            % \item Scope of Work
            % \item Definition of Terms and Concepts
        \end{itemize}
        \section{Preamble}
        \paragraph{In}
		...
		\section{Motivation}
			...
			\begin{enumerate}
				...
				\item \underline{Core Papers}: A student group cannot take more than one \textit{core} exam a day
				\item \underline{Difficulty Level}: A student group cannot have two \textit{difficult}\footnote{Difficulty level for each course is assessed by some Institution-wide accepted metric(s)} exams in two consecutive days
            ...
            \paragraph{}
            	This study takes a whole new look at Mathematical Optimization: what if our optimization goal doesn't involve minimizing ( or maximizing ) any variable or group of variables such as cost, profit, or even price? What if we're on the other hand interested in
                \begin{verse}
                    \textit{
                        \begin{center}
		...
		\section{Objective}
            \paragraph{}
                While this study seeks to address Assignment Problems involving objects with certain characteristics of interest, the specific objectives of this study are to:
                \begin{enumerate}[(i)]
				...
				\begin{verse}
					\textit{
						\begin{center}
							...
							\\where $A \subset X $ and $\mu_A \colon \textbf{R} \to [0,1]$, called the \emph{membership function of A}\cite{fuz}
						\end{center}
					}
				\end{verse}
	...
	\chapter{Solving A Sample Problem}
		...
		\section{Capacities}		
			...
			\paragraph{}
				...
				\end{align}
				\begin{align}
					\mid p_1 \mid &= w_1 \times 20 = 0.143 \times 20 = 2.86 \approx 3 \label{eq:p0} \\
					...
					\mid p_5 \mid &= w_5 \times 20 = 0.476 \times 20 = 9.52 \approx 9 \label{eq:pn}
				\end{align}
		\section{Constraints}
			...
			\paragraph{Now,}
				...
				\end{align}
				% The constraint values are summarized in the next page:
				...
				\begin{center}
					\begin{landscape}
						\begin{longtable}[c]{|l|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|}
							...
							% \hline
							% \multicolumn{10}{ r }{...continued from previous page}\\
							% \hline
							% \textbf{$i$} & \textbf{$\mu_{A_1}$} & \textbf{$\mu_{B_1}$} & \textbf{$\mu_1 = \mu_{A_1}\cdot\mu_{B_1}$} & \textbf{$\mu_{A_2}$} & \textbf{$\mu_{B_2}$} & \textbf{$\mu_2 = \mu_{A_2}\cdot\mu_{B_2}$}& \textbf{$\mu_{A_3}$} & \textbf{$\mu_{B_3}$} & \textbf{$\mu_{A_3}\cdot\mu_{B_3}$}  & \textbf{$\mu_{A_4}$} & \textbf{$\mu_{B_4}$} & \textbf{$\mu_{A_4}\cdot\mu_{B_4}$} & \textbf{$\mu_{A_5}$} & \textbf{$\mu_{B_5}$} & \textbf{$\mu_{A_5}\cdot\mu_{B_5}$}\\
							% \hline
							% \endhead
							...
							% \caption{Showing the constraint values, for $\mu_1, \mu_2 \text{ and } \mu_3$ }\label{table:tb1}\\
							% \endlastfoot
