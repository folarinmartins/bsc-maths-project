...
\begin{document}
	...
	\chapter{Literature Review}
		...
		\section{Linear Programming (LP)}
			As highlighted above, Linear Programming techniques often lend themselves to making optimum resource allocation in many cases. The following definition accurately captures these techniques:
			\begin{verse}
				\textit{
					\begin{center}
